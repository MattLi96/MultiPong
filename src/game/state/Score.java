 ...
 */
public class Score {
	private ConcurrentHashMap<String, Integer> lives; // name to number of lives
														// left
	 ...
	 */
	public Score(Set<String> players) {
		this(players, 1);
	}
	 ...
	 */
	public Score(Set<String> players, int startLives) {
		winner = null;
	...
	/**
	 * @return A copy of the current lives
	 */
	public Map<String, Integer> getLives() {
		return new HashMap<String, Integer>(lives);
	}
